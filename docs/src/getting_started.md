...
<p><img src="images/henon-simulation.svg" alt="Hénon attractor" width=60%/></p>
...
Instead of trying to approximate the attractor by a long forward trajectory, we will capture it by computing a collection of boxes (i.e. cubes) covering it. 
