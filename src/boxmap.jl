...
function transition_graph(g::BoxMap, boxlist::BoxList)
    boxset = BoxSet(boxlist)
    ...
    return BoxGraph(boxlist, edges_normed)
end

transition_graph(g::BoxMap, boxset::BoxSet) = transition_graph(g, BoxList(boxset))
